...
console.log(epify("ADAD ASDAS ADS my name is"))
...
const check3and7 = (nPositivo) => {
    if (nPositivo >= 0) {
        if (nPositivo % 3 === 0 || nPositivo % 7 === 0) {
